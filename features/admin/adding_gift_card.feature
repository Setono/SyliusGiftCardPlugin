...
Feature: Creating a gift card
  ...
  Scenario: Creating a gift card
    ...
    And I specify its amount as "$100.00"
    And I specify its currency code as "USD"
    And I specify its channel as "United States"
    And I add it
    Then I should be notified that it has been successfully created
    And I should see a gift card with code "GIFT-CARD-100" valued at "$100.00"
  ...
  Scenario: Creating a gift card for a customer
    ...
    And I add it
    Then I should be notified that it has been successfully created
    And I should see a gift card with code "GIFT-CARD-100" valued at "$100.00" associated to the customer "john-doe@setono.com"
    And this gift card should have api origin
