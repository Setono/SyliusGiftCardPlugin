...
Feature: Browsing existing gift cards
  ...
  Background:
    ...
    And the store has a gift card with code "GIFT-CARD-200" valued at "$200.00"

  @api
  Scenario: Browsing gift cards
    When I browse gift cards
    Then I should see a gift card with code "GIFT-CARD-100" valued at "$100.00"
    And I should see a gift card with code "GIFT-CARD-200" valued at "$200.00"
