        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('redemption')
                    ...
                    ->children()
                        ->enumNode('mode')
                            ->info('Whether redeeming a gift card results in an order adjustment or a real payment')
                            ->values(['adjustment', 'payment'])
                            ->defaultValue('adjustment')
                        ->end()
                        ->scalarNode('payment_method_code')
                            ->info('The code of the payment method used for gift card payments (payment mode only)')
